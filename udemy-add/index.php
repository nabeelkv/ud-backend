...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!$udemy_html) {
        ...
        $getInstructorName = trim($array->visible_instructors[0]->title);
        ...
        <div class="col-xl-12" style="user-select: auto;">
         ...
         <form class="needs-validation" novalidate="" style="user-select: auto;" method="POST">
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control text-center py-2 px-2" id="udemyURL" placeholder="Udemy Course URL" value="" required="" name="udemyURL" onclick="Paste('udemyURL')">
              ...
              <select class="form-select text-center py-2" aria-label="Default select example" name="courseType" class="" style="display:none;">
