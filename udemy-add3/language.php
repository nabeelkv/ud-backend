...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $getcourseTopic = $_POST['courseTopic'];
    ...
    if(!$udemy_html) {
		...
		$courseTopic = trim($getcourseTopic);
        ...
        $courseDurationInHours = $getcourseDuration;
        ...
        <div class="col-xl-12" style="user-select: auto;">
         ...
         <form class="needs-validation" novalidate="" style="user-select: auto;" method="POST">
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control text-center py-2" id="courseTopic" placeholder="Course Topic" value="" required="" name="courseTopic">
